...
local spell_name = "haste"
local disp_name = "Haste"

local gravity_ratio = 0.2

local description =
	"Increases your speed.\n\n"
	.. "Cost: 3 * uses * duration"
...
local form_name = "travel_spells:haste"
...
local function calculate_cost(aptitudes, meta)
	return 3 * meta.uses * meta.duration
end
...
local function do_it(tab)
	...
	local succ = monoidal_effects.apply_effect("travel_spells:haste",
						   dur * 60,
